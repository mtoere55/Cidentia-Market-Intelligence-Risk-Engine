...
<head>
  ...
  <style>
    ...
    table { width:100%; min-width:1420px; border-collapse:collapse; margin-top:14px; }
...
app.post('/order/live', (req, res) => {
  res.status(403).json({ accepted: false, reason: 'LIVE_ORDER_ENDPOINT_LOCKED_IN_SAFE_FOUNDATION_VERSION', message: 'Use virtual trading first. Live execution is intentionally blocked.' });
});
